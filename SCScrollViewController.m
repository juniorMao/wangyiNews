...
#define CHOOSEBUTTONFEFAULTHEIGHT 37
...
-(void)refreshVC{
    ...
    self.scrollView.frame = CGRectMake(0, 64, SCREENWIDTH, SCREENHEIGHT-64-self.tabBarVcHeight);
...
-(UIScrollView *)scrollView{
    if (nil == _scrollView) {
        ...
        [self.chooseViewArray enumerateObjectsUsingBlock:^(UIView * subView, NSUInteger index, BOOL * _Nonnull stop) {
            CGRect frame = CGRectMake(SCREENWIDTH*index, (self.chooseButtonHeight) + LINEHEIGHT+5, SCREENWIDTH, SCREENHEIGHT-LINEHEIGHT-(self.chooseButtonHeight)-64-5-self.tabBarVcHeight);
            
            UIView *view = [[UIView alloc]initWithFrame:frame];
            view.backgroundColor = [UIColor whiteColor];
            
            UIView *subViewSuperView = [[UIView alloc]initWithFrame:view.bounds];
...
//                    NSLog(@"%f %f",vc.contentOffset.y,currentPoint.y);
                    ...
                    if (vc.contentOffset.y > 0 || currentPoint.y == 0) {
                        ...
                        if (currentPoint.y > vc.contentOffset.y) {
                            ...
                            [UIView animateWithDuration:0.25 animations:^{
                                vc.superview.superview.frame = CGRectMake(SCREENWIDTH*index, 0, SCREENWIDTH, SCREENHEIGHT-64-self.tabBarVcHeight);
                                vc.frame = vc.superview.superview.bounds;
//                                vc.contentSize = CGSizeMake(vc.contentSize.width, vc.contentOffset.y + SCREENHEIGHT - self.tabBarVcHeight - _chooseButtonHeight);
                            ...
                            [UIView animateWithDuration:0.3 animations:^{
                                ...
                                vc.superview.superview.frame = CGRectMake(SCREENWIDTH*index, (self.chooseButtonHeight) + LINEHEIGHT+5, SCREENWIDTH, SCREENHEIGHT-LINEHEIGHT-(self.chooseButtonHeight)-64-5-self.tabBarVcHeight);
                                vc.frame = vc.superview.superview.bounds;
                            }];
                    }
...
-(UIView *)scrollLineView{
    if (nil == _scrollLineView) {
        ...
        UIView *colorLine = [[UIView alloc]initWithFrame:CGRectMake((_scrollLineView.frame.size.width-50)*0.5, 0, 50, LINEHEIGHT)];
    ...
    if (!_chooseButtonWidth) {
        switch (_chooseButtonArray.count) {
            ...
            case 3:
                ...
                break;
            case 4:
                self.chooseButtonWidth = SCREENWIDTH / 4;
                break;
            default:
                self.chooseButtonWidth = SCREENWIDTH / 4.5;
                break;
        }
    }
